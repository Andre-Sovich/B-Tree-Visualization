...
static constexpr auto qt_meta_stringdata_ZN8TreeNodeE = QtMocHelpers::stringData(
    "TreeNode"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TreeNodeE[] = {
...
Q_CONSTINIT const QMetaObject TreeNode::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TreeNodeE.offsetsAndSizes,
    qt_meta_data_ZN8TreeNodeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8TreeNodeE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TreeNode, std::true_type>
    >,
    nullptr
} };
...
void *TreeNode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TreeNodeE.stringdata0))
