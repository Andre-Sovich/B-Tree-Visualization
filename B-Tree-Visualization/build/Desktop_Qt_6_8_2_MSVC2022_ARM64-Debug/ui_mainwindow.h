...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        message_display_textedit->setGeometry(QRect(707, 118, 200, 442));
        ...
        graphicsView->setGeometry(QRect(9, 118, 256, 192));
        ...
        btree_radio_button = new QRadioButton(layoutWidget);
        ...
        bplus_radio_button = new QRadioButton(layoutWidget);
        ...
        bstar_radio_button = new QRadioButton(layoutWidget);
